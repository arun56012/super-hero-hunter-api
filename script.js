...
//     if (value === "") {
//       userCardContainer.innerHTML = ""; // Clear all items
//       return; // Exit early
//     }
...
//                   String(result.id).toLowerCase().includes(value);

//       if (isVisible) {
//         userCardContainer.append(result.element); // Add the matching card
//       }
//     });
...
//   //  const URLAPI= 'https://gateway.marvel.com:443/v1/public/characters?limit=20&apikey=83208ce86db45aae1eb14c67d2ed8543&hash=e1f6729a29bb880204d0a7da231f0a6b'
...
//              results = data.data.results.map(result=>{
...
//                     favorite => favorite.name === characterDetails.name
//                   );
...
//                   // Pass data to the new page (use sessionStorage or query parameters)
//                   sessionStorage.setItem("characterDetails", JSON.stringify(characterDetails));
          
//                   // Redirect to the new page
//                   window.location.href = "character-details.html"; // Replace with your details page URL
...
//            results.forEach(result => userCardContainer.append(result.element));
//           })
